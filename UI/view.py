...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.btn_analizza_aeroporti = ft.ElevatedButton(text="Analizza Aeroporti", on_click=self._controller.handle_analizza_aeroporti)
        row1 = ft.Row([self.txt_distanza, self.btn_analizza_aeroporti],
